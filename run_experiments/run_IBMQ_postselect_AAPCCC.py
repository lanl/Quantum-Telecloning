...
def get_transpiled_circuits(angle_ry, angle_rz):
	qc_tc, clone_indices, _, post_select_indices = construct_AAPCCC_postselect_00(angle_ry, angle_rz)
	...
	qc_tc, clone_indices, _, post_select_indices = construct_AAPCCC_postselect_11(angle_ry, angle_rz)
	...
	qc_tc, clone_indices, _, post_select_indices = construct_AAPCCC_postselect_10(angle_ry, angle_rz)
	...
	qc_tc, clone_indices, _, post_select_indices = construct_AAPCCC_postselect_01(angle_ry, angle_rz)
...
id = job.job_id()
print(id)
job_filename = "AAPCCC_"+device_name+subgraph_name+"_"+str(N_shots)+"_"+str(N_Angle_slices)+"_00_OPT_"+str(OPT_LEVEL)+".txt"
...
id = job.job_id()
print(id)
job_filename = "AAPCCC_"+device_name+subgraph_name+"_"+str(N_shots)+"_"+str(N_Angle_slices)+"_01_OPT_"+str(OPT_LEVEL)+".txt"
file = open("job_ids_postselect/"+job_filename, "w")
file.write(str(id))
file.close()
...
id = job.job_id()
print(id)
job_filename = "AAPCCC_"+device_name+subgraph_name+"_"+str(N_shots)+"_"+str(N_Angle_slices)+"_10_OPT_"+str(OPT_LEVEL)+".txt"
file = open("job_ids_postselect/"+job_filename, "w")
file.write(str(id))
file.close()
...
id = job.job_id()
print(id)
job_filename = "AAPCCC_"+device_name+subgraph_name+"_"+str(N_shots)+"_"+str(N_Angle_slices)+"_11_OPT_"+str(OPT_LEVEL)+".txt"
file = open("job_ids_postselect/"+job_filename, "w")
file.write(str(id))
file.close()
